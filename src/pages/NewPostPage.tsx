import { ShareFat, WarningCircle } from "@phosphor-icons/react";
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            try {
                ...
                setErrors({ message: "Något gick fel vid API-anropet" });
        ...
        <div className="p-4 pt-8 md:p-16">
            ...
            <div className="bg-white rounded-lg mt-4 p-8 max-w-screen-md drop-shadow-sm">
                <form onSubmit={handleSubmit} className="grid grid-cols-3">
                    ...
                    >
                        {isSubmitting ? <><span className="me-2">Publicera</span> <ShareFat size={24} /></>
                            :
                            <>
